-- Insert the demo data in the Customers table
...
-- Insert the demo data in the Product table
...
-- Insert the demo data in the Orders table
...
-- Insert the demo data in the Order_items table
...
-- Insert the demo data in the Payments tabel 
